...
gcc -o aufgabe_1 src/main.o src/buffer.o src/client.o src/server_handler.o src/server.o -lpthread -lm -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_legacy
